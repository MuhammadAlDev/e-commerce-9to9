...
WebUI.click(findTestObject('Object Repository/9to9_OR/Page_Masuk/input_Email_username'))

WebUI.setEncryptedText(findTestObject('Object Repository/9to9_OR/Page_Masuk/input_Password_password'), 'g23AgEuKqCtpsrLBOAi2Dg==')

WebUI.click(findTestObject('Object Repository/9to9_OR/Page_Masuk/span_Masuk'))

WebUI.click(findTestObject('Object Repository/9to9_OR/Page_Masuk/p_Email tidak boleh kosong'))
