...
WebUI.setEncryptedText(findTestObject('Object Repository/9to9_OR/Page_Masuk/input_Password_password'), '9NLz+4tGZcQ=')

WebUI.click(findTestObject('Object Repository/9to9_OR/Page_Masuk/span_Masuk'))

WebUI.click(findTestObject('Object Repository/9to9_OR/Page_Masuk/p_Password tidak boleh kosong'))
